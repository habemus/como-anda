(function () {
   ...
   * 
   */
  function AnimateBackgroundImages(element, options) {
  ...
  AnimateBackgroundImages.prototype.setup = function (options) {
  ...
  AnimateBackgroundImages.prototype._getFrameUrlBuilder = function () {
    var prefix;
    var suffix;
  ...
  AnimateBackgroundImages.prototype.getFramesUrls = function () {
  ...
  AnimateBackgroundImages.prototype.loadFrames = function () {
  ...
  AnimateBackgroundImages.prototype.run = function () {
    var _this = this;
  ...
  if (targets) {
    for (var i = 0; i < targets.length; i++) {
      new AnimateBackgroundImages(targets[i]);
    }
  }

  window.animateBackgroundImages = function (el, options) {
    return new AnimateBackgroundImages(el, options);
  };
